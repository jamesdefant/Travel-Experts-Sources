...
CREATE TABLE `agents` (
  ...
  `AgtUserId` varchar(20) DEFAULT NULL,
  `AgtPassword` varchar(20) DEFAULT NULL
...
(145, 'Jeremiah', 'Jackson', '62 87th Ave, NE', 'Calgary', 'AB', 'T3B 8D5', 'Canada', '4034797323', '4032348423', '', 4, 'user', 'password');
-- --------------------------------------------------------
